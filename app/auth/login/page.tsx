    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-bg-secondary border border-border-default rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-bg-tertiary border border-border-default hover:border-gray-600 text-white text-sm font-medium py-2.5 rounded-xl transition-all"
            >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-accent-light hover:text-blue-300 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          ...
          <Link href="/auth/signup" className="text-accent-light hover:text-blue-300 transition-colors font-medium">
            Sign up for free
          </Link>
        </p>
      </div>
